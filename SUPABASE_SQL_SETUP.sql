-- ============================================
-- Career Fair Buddy - Supabase Database Setup
-- ============================================
...
-- ============================================
-- RLS POLICIES: Prep Checklist Items
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_career_fairs_user_id ON career_fairs(user_id);
CREATE INDEX IF NOT EXISTS idx_career_fairs_date ON career_fairs(date DESC);
CREATE INDEX IF NOT EXISTS idx_companies_career_fair_id ON companies(career_fair_id);
CREATE INDEX IF NOT EXISTS idx_companies_priority ON companies(priority);
CREATE INDEX IF NOT EXISTS idx_companies_created_at ON companies(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_checklist_items_career_fair_id ON prep_checklist_items(career_fair_id);
CREATE INDEX IF NOT EXISTS idx_checklist_items_display_order ON prep_checklist_items(display_order);
...
DO $$
BEGIN
  RAISE NOTICE '✅ Database setup complete! All tables, policies, and indexes have been created.';
END $$;
