      ...
      <Card className="relative w-full max-w-md shadow-soft-lg border-0 animate-scale-in">
        ...
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription className="text-base">
            Start managing your career fairs today
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-3 text-sm cursor-pointer">
              <input
                type="checkbox"
                required
                className="mt-0.5 h-5 w-5 rounded border-2 border-input text-primary focus:ring-2 focus:ring-primary/20 focus:ring-offset-2 cursor-pointer"
              />
